...
public class StartOptions : MonoBehaviour
{
    ...
    //[HideInInspector] public GameObject menuButtons = GameObject.Find("MenuButtons");
    ...
    public void StartButtonClicked()
    {
        ...
        if (changeScenes)
        {
            ...
            //animColorFade.SetTrigger("fade"); //If you comment this line error vanishes, but there's no transition at all. 
        }
    ...
    void AnimateButtons()
    {
        ...
        Buttons.Add(GameObject.Find("Credits"));
